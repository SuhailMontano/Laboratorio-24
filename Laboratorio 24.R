...
#                  #
####################
# Hecho con gusto por Suhail Montaño Sánchez
...
genes <- as.matrix(
  read.csv("C:\\Users\\Suha\\Downloads\\heatmap_data.csv",
            sep = "," ,
            header = T,
            row.names = 1))

annotation_col <- read.csv( "C:\\Users\\Suha\\Downloads\\annotation_col.csv", header = T,
                            row.names = 1)

annotation_row <- read.csv( , header = T,
                            row.names = 1)
